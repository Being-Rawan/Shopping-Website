...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `pro`(name, price, image) VALUES('$p_name', '$p_price', './upload/$p_image')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `pro` SET name = '$update_p_name', price = '$update_p_price', image = './upload/$update_p_image' WHERE id = '$update_p_id'");
...
<head>
   ...
   <link rel="stylesheet" href="cart/css/style2.css">
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <img src="../IT-project/karl-master/upload/<?php echo $fetch_edit['image']; ?>" height="200" alt="">
